...
export const uploadPicture = (data, id) => {    
    ...
    export const followUser = (followerId, idtoFollow) => {
        return (dispatch) => {
          return axios
            .patch(`http://localhost:3001/api/user/follow/${followerId}`, { idtoFollow })
      ...
      export const UnfollowUser = (followerId, idtoUnfollow) => {
        return (dispatch) => {
          return axios
            .patch(`http://localhost:3001/api/user/unfollow/${followerId}`, { idtoUnfollow })
